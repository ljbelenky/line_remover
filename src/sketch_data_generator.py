...
class SketchDataGenerator:
    ...
    #             lines = RulerGenerator(shape=sketch.size, line_width=line_width, spacing=spacing, v_offset=v_offset,
    #                                    raggedness=raggedness, color=color, color_variation=color_variation, angle=angle).image
